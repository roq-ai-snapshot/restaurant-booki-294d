  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Restaurant booking engine - Streamlining your dining experience. An innovative platform for customers to reserve tables and for restaurant staff to efficiently manage reservations and menus."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Restaurant booking engine - Streamlining your dining experience. An innovative platform for customers to reserve tables and for restaurant staff to efficiently manage reservations and menus.`}
            </Text>
            <Box
